...
class GeoCoord:
    ...
    def _calc_degreeminutes(decimal_degree):
        ...
        sign = own_cmp(decimal_degree, 0) # Store whether the coordinate is negative or positive
...
#    def __cmp__(self, other):
 #       return own_cmp(self.decimal_degree, other.decimal_degree)
...
#    def __cmp__(self, other):
#        return own_cmp(self.magnitude, other.magnitude)
